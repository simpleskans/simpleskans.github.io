...
resumo: 'Capítulo 3 | Smash Pass'
capa: '/img/postcapa/slsp3.jpg'
autorL: 'Season 4'
        ...
        <div class="ladoE">
           ...
           <div class="separador"></div>
            <section class="galeriawebtoon">
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/1eckmD4.png" alt="{{ page.resumo }} - Página 1" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/mahhOZR.png" alt="{{ page.resumo }} - Página 2" />
                </figure>
            </section>
            <div class="separador"></div>
            {% include capnav.html %} 
