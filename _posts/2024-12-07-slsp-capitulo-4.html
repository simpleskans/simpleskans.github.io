        ...
        <div class="ladoE">
           ...
           <div class="separador"></div>
            <section class="galeriawebtoon">
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/nF7odTC.png" alt="{{ page.resumo }} - Página 1" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/iXAO8Nj.png" alt="{{ page.resumo }} - Página 2" />
                </figure>
            </section>
            <div class="separador"></div>
            {% include capnav.html %} 
