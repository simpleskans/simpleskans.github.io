...
<article>
    <div class="topowebtoon">
        <figure>
            <img src="{{ page.capa }}" alt="Capa de {{ page.title }}" style="object-position: center 19.52%" />
        </figure>
        <h1>{{ page.title }}</h1>
    ...
    <div class="corpo">
        <div class="ladoE">
            ...
            <section class="galeriawebtoon">
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/cVr7aDZ.png" alt="{{ page.resumo }} - Página 1" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/mnZa23C.png" alt="{{ page.resumo }} - Página de Créditos" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/bVjWKbq.png" alt="{{ page.resumo }} - Página 2" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/eYZhKNS.png" alt="{{ page.resumo }} - Página 3" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/hyDc4A5.png" alt="{{ page.resumo }} - Página 4" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/TyUgdc6.png" alt="{{ page.resumo }} - Página 5" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/Ya2d8WP.png" alt="{{ page.resumo }} - Página 6" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/BrI4Fdu.png" alt="{{ page.resumo }} - Página 7" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/2UppNdU.png" alt="{{ page.resumo }} - Página 8" />
                </figure>
