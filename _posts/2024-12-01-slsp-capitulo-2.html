        ...
        <div class="ladoE">
           ...
           <div class="separador"></div>
            <section class="galeriawebtoon">
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/i6JscZY.png" alt="{{ page.resumo }} - Página 1" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/lY7Sias.png" alt="{{ page.resumo }} - Página 2" />
                </figure>
            </section>
            <div class="separador"></div>
            {% include capnav.html %} 
