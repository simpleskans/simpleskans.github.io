...
descricao: 'Tradução do Capítulo 05 da Webtoon de Smash Legends para português'
categories: smash-legends
tags: slw neve
permalink: /:categories/:title
resumo: 'Capítulo 5 | Webtoon'
capa: '/img/postcapa/slw5.png'
...
<article>
    <div class="topowebtoon">
        <figure>
            <img src="{{ page.capa }}" alt="Capa de {{ page.title }}" style="object-position: center 67.16%" />
        </figure>
        <h1>{{ page.title }}</h1>
    ...
    <div class="corpo">
        <div class="ladoE">
            ...
            <section class="galeriawebtoon">
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/dYcKbi9.png" alt="{{ page.resumo }} - Página 1" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/4ZF1MXY.jpg" alt="{{ page.resumo }} - Página de Créditos" />
                </figure>
                
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/Ld0Q4Q7.png" alt="{{ page.resumo }} - Página 2" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/9rar9Fx.png" alt="{{ page.resumo }} - Página 3" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/qXPItVu.png" alt="{{ page.resumo }} - Página 4" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/xJXmRQi.png" alt="{{ page.resumo }} - Página 5" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/01yhSeR.png" alt="{{ page.resumo }} - Página 6" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/2h6WnwW.png" alt="{{ page.resumo }} - Página 7" />
                </figure>
                <figure>
                    <img loading="lazy" src="https://i.imgur.com/934L1I1.png" alt="{{ page.resumo }} - Página 8" />
                </figure>
